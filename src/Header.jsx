...
function Header() {
  ...
  return (
    <header className="bg-white shadow-md px-4 py-3 something">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          {/* <Link to="/BookService" className="text-black hover:text-blue-900 hover:font-bold">Book Service</Link> */}
      ...
      {isMenuOpen && (
        <div className="md:hidden px-4 pt-2 pb-4 space-y-2">
          ...
          <Link to="/BookService" className="block text-black hover:text-blue-900 hover:font-bold">Book Service</Link>
